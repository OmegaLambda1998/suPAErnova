...
KEYS = [
    k for k in NFlowStepResult.model_fields if k not in {"log_prob", "z_to_u", "u_to_z"}
]


@pytest.mark.setup("legacy_snpae")
def test_legacy_nflow_setup(legacy_nflow: "NFlowStepResult") -> None:
    pass


@pytest.mark.setup("snpae")
def test_snpae_nflow_setup(snpae_nflow: "NFlowStepResult") -> None:
    pass
...
def test_shapes(
    key: str,
    snpae_nflow: "NFlowStepResult",
    legacy_nflow: "NFlowStepResult",
) -> None:
...
def test_matching_neg_log_prob(
    ...
    utils.assert_arrays(snpae_vals, legacy_vals, metadata={"key": "neg_log_prob"})
...
def test_matching_neg_log_prob_means(
    ...
    utils.assert_arrays(
        ...
        metadata={"key": "mean neg_log_prob"},
    )
...
def test_matching_z_to_u(
    ...
    utils.assert_arrays(snpae_vals, legacy_vals, metadata={"key": "z_to_u"})
...
def test_matching_u_to_z(
    ...
    utils.assert_arrays(snpae_vals, legacy_vals, metadata={"key": "u_to_z"})
...
def test_matching_z_to_uz(
    ...
    utils.assert_arrays(snpae_vals, legacy_vals, metadata={"key": "z_to_uz"})
