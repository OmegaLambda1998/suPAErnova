...
class PAEConfig(BackendConfig):
    ...
    delta_m_epochs: PositiveInt = 10000
    delta_m_patience: PositiveFloat | PositiveInt = 0.25  # Run for 50%
    ...
    delta_p_epochs: PositiveInt = 10000
    delta_p_patience: PositiveFloat | PositiveInt = 0.25  # Run for 50%
    ...
    final_epochs: PositiveFloat = 10000
    final_patience: PositiveFloat | PositiveInt = 0.25  # Run for 50%
